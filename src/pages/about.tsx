      ...
      <div className='about-grid'>
        <div className='about-item wide'>
          ...
          transition={{delay: 0.2}}>
            ...
            desenhando ou pintando, jogando algum videogame ou me aprendendo algo relacionado à programação, ciências sociais ou 
          ...
          <motion.div
            ...
            transition={{delay: 0.6}}>
              ...
              <ul className="list-disc list-inside text-neutral-600 space-y-2 mb-12">
                ...
                <li><strong>Prototipação and Wireframing</strong></li>
                <li><strong>Experiência de Usuário (UX) Design</strong></li>
                <li><strong>Frontend Development</strong> (SQL, NoSQL, APIs REST, GraphQL, Python, JavaScript/TypeScript)</li>
                <li><strong>Backend Development</strong> (HTML, CSS, JavaScript, React)</li>
                <li><strong>Machine Learning Engineer</strong> (Visão Computacional, Redes Neurais Artificiais, Machine Learning, Deep Learning)</li>
                <li><strong>Versionamento com Git</strong></li>
              </ul>
          </motion.div>
        </div>
          ...
          <motion.div
            ...
            transition={{delay: 0.6}}>
              ...
              <ul className="list-disc list-inside text-neutral-600 space-y-2">
                <li><strong>Gerenciamento de Projetos e Produtividade</strong> (Trello, Plane, Obsidian)</li>
                ...
                <li><strong>Backend Development</strong> (Node.js, Express, FastAPI, NestJS, Django)</li>
